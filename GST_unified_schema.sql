...
CREATE TABLE IF NOT EXISTS public.GST_cierres_caja (
    ...
    fecha timestamp with time zone DEFAULT timezone('utc'::text, now()) NOT NULL,
    turno text NOT NULL,
    medio_01 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_02 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_03 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_04 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_05 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_06 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_07 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_08 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_09 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_10 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_11 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_12 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_13 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_14 numeric(12,2) DEFAULT 0.00 NOT NULL,
    medio_15 numeric(12,2) DEFAULT 0.00 NOT NULL,
